    ...
    <section className="section" id="lakeland">
      <div className="wrapper" id="lakeland-wrapper">
        ...
        <h1 className="first-line">
          'It’s quietly dying’: A new cycle of redevelopment could threaten Lakeland and other historic College Park neighborhoods
        </h1>
        ...
        <p>
          ...
          <br /><br />
          Kerry Snow, a longtime North College Park resident, said servicesthings such as parking and code enforcement have languished in recent years at the expense of the partnership’s vision.
          <br /><br />
          “There are some things that I think may be suffering because the city is trying to do so much with downtown,” said Snow, a three-time graduate of this university. “A lot of my neighbors complain about houses that are abandoned … and look like they’re going to crash to the ground.”
          <br /><br />
