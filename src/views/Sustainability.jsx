  ...
  return (
    <section className="section" id="sustainability">
      <div className="wrapper" id="sustainability-wrapper">
        ...
        <p className="descrip">
          College Park achieved this certification in 2013 and it is renewable up to three years. In 2016, the city became recertified.
          <br /> <br />
        ...
        <p className="descrip">
          ...
          <br /><br />
          College Park has been a Tree City USA for more than two decades. The program recognizes cities that promote healthy tree management. This university — as of 2016 more than 26 percent of this campus is covered in trees — is part of Tree Campus USA, a similar program but strictly for colleges and universities.
          <br /><br />
          ...
          <br /><br />
          This university has an initiative called the Partnership for Action Learning in Sustainability, which partnered with College Park in 2015 to address sustainability challenges. Students in specific classes have helped multiple areas and counties in Maryland. Past College Park projects included recommendations for reducing solid waste and increasing recycling and plans for the development of a greenhouse gas inventory.
        </p>
        ...
        <p className="descrip">
          ...
          <br /> <br />
          Solar energy options for city residents include joining a co-op (where a group of people share the cost together), purchasing individual solar panels and forming a power purchase agreement with a contractor (where the homeowner signs a lease for the contractor to buy, install and maintain the panels).
          <br /><br />
        ...
        <p className="descrip">
          Assist the City and County with increasing recycling rates as well as homeowner participation in the County “Rain Check” program to install environmental site design and rain barrels at homes in the City of College Park. Partnership promoting.
          <br /> <br />
          As of a few months ago, 22 people in College Park had applied for the rain check rebate. It is a financial incentive program, which “provides eligible applicants the opportunity to receive a reimbursement for installing approved stormwater management practices,” according to the Chesapeake Bay Trust website.
          <br /><br />
        ...
        <p className="descrip">
          The city currently purchases 100 percent renewable energy off-site from a regional contractor. On-site, it currently produces 10 percent of clean energy using the solar panels recently installed. The city is on track to meet the goal of producing 20 percent of municipal energy needs from on-site renewable energy by 2020.
          <br /> <br />
          “The challenge is that electricity is being purchased by individual account holders, every single household and business in College Park,” said Mark Stewart,sustainability manager for this university’s Office of Sustainability. “More than 10,000 are unique Pepco accounts, and whereas each individual can choose to receive clean energy, there needs to be a way to provide it for all utility customers so every individual won’t have to take action.”
          <br /><br />
          Stewart, who is also one of the co-chairs of the city’s sustainability committee, said a possible way to increase renewable energy on-site is to create a large-scale renewable energy project on or off-site. This would generate electricity itself and help to offset non-renewable energy usage in College Park. The cost could be around $100,000 a year for the city.
          <br /><br />
        ...
        <p className="descrip">
          ...
          <br /><br />
          The William S. Schmidt Outdoor Education Center partnered with the city with the goal of having every school serving College Park students become a green school. The center “provides many resources and support for schools to become green schools including professional development, application support, green projects support, and more,” according to a meeting document. The city sustainability committee is working on finding a way for this university to work with the center to support local College Park schools with Green School projects.
          <br /><br />
          “This may include developing course credit, adding projects to the DoGood Challenge on campus, working with a UMD Honors team or UMD Scholars project,” according to the document.
          <br /><br />
